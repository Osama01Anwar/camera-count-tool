...
``registry/camera_database/canon.yaml``, where each entry carries a
...
until a vendor read operation is documented for a Canon body; while it
...
class CanonAdapter(RegistryAdapter):
    """Reads the documented counters for Canon bodies."""

    manufacturer_key: ClassVar[str] = "Canon"
