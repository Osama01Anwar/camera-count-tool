...
``registry/camera_database/nikon.yaml``, where each entry carries a
...
until a vendor read operation is documented for a Nikon body; while it
...
class NikonAdapter(RegistryAdapter):
    """Reads the documented counters for Nikon bodies."""

    manufacturer_key: ClassVar[str] = "Nikon"
